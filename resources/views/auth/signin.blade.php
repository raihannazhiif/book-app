...
<main class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-blue-900  to-black p-6">
    <div class="w-full max-w-md bg-gray-700 text-white rounded-3xl shadow-2xl p-8 transition-transform transform hover:shadow-blue-500/50">
