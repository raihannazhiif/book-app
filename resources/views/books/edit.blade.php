...
<section class="p-8 min-h-screen flex justify-center items-center bg-blue-900 text-white">
    <div class="max-w-3xl w-full bg-gray-600 bg-opacity-40 backdrop-blur-lg p-6 rounded-xl shadow-lg">
        ...
        <form action="{{ route('book.update' , $book->slug ) }}" method="post" 
            ...
            {{-- Submit Button --}}
            <button type="submit" class="w-full p-4 bg-blue-500 text-white font-medium rounded-lg shadow-lg hover:bg-blue-600 transition transform hover:scale-105">
                ✨ Update Book
            </button>
        </form>
