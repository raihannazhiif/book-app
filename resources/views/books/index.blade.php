...
@section('content')
<section class="p-10 min-h-screen bg-blue-900 text-white flex justify-center items-center">
    <div class="max-w-6xl w-full">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            @forelse ($books as $book)
                <div class="bg-gray-700 bg-opacity-50 backdrop-blur-md p-4 rounded-xl shadow-lg hover:scale-105 transition">
