<div class="flex justify-between items-center p-6 bg-gray-700 text-white shadow-lg">
    {{-- Logo --}}
    ...
    <nav class="flex gap-4 items-center">
        ...
        @else
            ...
            <a href="{{ route('sign-up-form') }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg shadow-md transition">
                Sign Up
            </a>
        @endauth
    </nav>
